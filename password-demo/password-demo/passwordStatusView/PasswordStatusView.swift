...
//  password-demo
//
//  Created by Johel Zarco on 07/07/22.
//
...
extension PasswordStatusView{
    ...
    func layout(){
        stackView.leadingAnchor.constraint(equalToSystemSpacingAfter: leadingAnchor, multiplier: 2).isActive = true
...
//        stackView.bottomAnchor.constraint(equalToSystemSpacingBelow: bottomAnchor, multiplier: 2).isActive = true
    }
